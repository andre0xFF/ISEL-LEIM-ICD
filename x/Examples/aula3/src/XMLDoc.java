...
final public class XMLDoc {
	...
	/**
	 * Devolve lista de nos gerada pela expressao xPath indicada
	 * 
	 * @param expression
	 *            xpath
	 * @param doc
	...
	/**
	 * Executa uma expressao XPath numa arvore DOM e devolve o 1� string (valor)
	 * 
	 * @param expression
	 * @param doc
	 * @return string que o valor do nó encontrado
	 * 
	 */
